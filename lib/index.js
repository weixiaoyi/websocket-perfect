...
var Ws = function Ws(_ref) {
  ...
  _defineProperty(this, "_createWebsocket", function () {
    ...
    ws.onmessage = function (e) {
      if (!_this._ws$.closed) {
        var result = [e, (0, _utils.formatJson)(e.data)];
  ...
  _defineProperty(this, "send", function () {
    ...
    try {
      ...
      var _this$_config2 = _this._config,
          bufferCount = _this$_config2.bufferCount,
      ...
      if (_this._subscribeRecords.length && bufferCount && _lodash.default.isInteger(bufferCount)) {
        _this._subscribeRecords = _this._subscribeRecords.slice(-bufferCount);
      }
